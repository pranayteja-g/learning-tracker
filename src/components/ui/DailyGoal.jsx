...
export function DailyGoalWidget({ goal, todayCount, pct, goalMet, goalStreak, onSetGoal, color = "#7b5ea7" }) {
  ...
  return (
    <div
      style={{
        background: goalMet ? "#1a2e1a" : "#16161b",
        borderRadius: 12,
        border: `1px solid ${goalMet ? "#52b78833" : "#1e1e24"}`,
        padding: "14px 16px",
        marginBottom: 12,
        transition: "all 0.3s",
      }}
    >
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <div>
            ...
            {goalStreak > 1 && <div style={{ fontSize: 10, color: "#ee9b00" }}>🔥 {goalStreak} day streak</div>}
          </div>
        </div>
        <button
      ...
      {editing ? (
        ...
        <>
          <div style={{ background: "#0f0f13", borderRadius: 4, height: 6, overflow: "hidden", marginBottom: 8 }}>
            <div
              style={{
                height: "100%",
                borderRadius: 4,
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <div style={{ fontSize: 12, color: goalMet ? "#52b788" : "#888", fontVariantNumeric: "tabular-nums" }}>
              {todayCount} / {goal}
            </div>
          </div>
        </>
