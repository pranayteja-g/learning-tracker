...
export function CompletionCertificate({ roadmap, stats, onClose }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.85)",
      ...
      <div style={{ background: "#16161b", borderRadius: 14, padding: "28px 24px",
        border: "1px solid #2a2a35", maxWidth: 440, width: "100%", textAlign: "center" }}>

        {/* Preview */}
        <div style={{ background: "#0f0f13", borderRadius: 10,
          border: `2px solid ${roadmap.color}44`, padding: "24px 20px", marginBottom: 20 }}>
          <div style={{ fontSize: 48, marginBottom: 8 }}>🏆</div>
          <div style={{ fontSize: 11, color: "#555", textTransform: "uppercase",
            letterSpacing: 2, marginBottom: 6 }}>Certificate of Completion</div>
        ...
        <button onClick={download}
          style={{ width: "100%", padding: "12px", background: roadmap.color,
        ...
        <button onClick={onClose}
          style={{ width: "100%", padding: "10px", background: "transparent",
            border: "1px solid #2a2a35", borderRadius: 9, color: "#666",
