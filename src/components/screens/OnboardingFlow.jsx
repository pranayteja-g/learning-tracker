  ...
  const dot = (i) => (
    <div
      ...
      style={{
        ...
        height: 6,
        borderRadius: 3,
        background: i <= step ? "#7b5ea7" : "#1e1e24",
        transition: "all 0.3s",
      }}
    />
  );
      ...
      {current === "welcome" && (
        <div style={{ maxWidth: 400, width: "100%", textAlign: "center" }}>
          ...
          <p style={{ color: "#666", fontSize: 15, lineHeight: 1.7, margin: "0 0 32px" }}>
            Your personal learning companion. Track progress across any roadmap, practice with AI,
            complete quests, and earn XP as you grow.
          </p>
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: "#555" }}>
                  Topics organised into sections you can tick off
                </div>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: "#555" }}>
                  Quizzes, coding challenges, Q&amp;A - all generated for you
                </div>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: "#555" }}>
                  Complete quests, earn badges, level up as you learn
                </div>
              </div>
            </div>
          </div>
      ...
      {current === "apikey" && (
        <div style={{ maxWidth: 420, width: "100%", textAlign: "center" }}>
          ...
          <p style={{ color: "#666", fontSize: 13, lineHeight: 1.7, margin: "0 0 24px" }}>
            Groq and Gemini are both free - no credit card needed. The key is stored only on your
            device.
          </p>
            ...
            {Object.entries(PROVIDERS).map(([id, p]) => (
              <button
                ...
                style={{
                  flex: 1,
                  padding: "9px",
                  background: aiConfig.provider === id ? "#7b5ea722" : "#16161b",
                  border: `1px solid ${aiConfig.provider === id ? "#7b5ea7" : "#2a2a35"}`,
                  borderRadius: 8,
                  color: aiConfig.provider === id ? "#c4b5fd" : "#555",
                  fontSize: 12,
                  fontWeight: aiConfig.provider === id ? 700 : 400,
                  cursor: "pointer",
                  fontFamily: "inherit",
                }}
              >
          ...
          <button
            ...
            style={{
              width: "100%",
              padding: "13px",
              background: hasKey ? "#7b5ea7" : "#1e1e24",
              border: `1px solid ${hasKey ? "transparent" : "#2a2a35"}`,
              borderRadius: 10,
              color: hasKey ? "#fff" : "#555",
              fontSize: 14,
              fontWeight: 700,
              cursor: "pointer",
              fontFamily: "inherit",
          ...
          {!hasKey && (
            <div style={{ fontSize: 11, color: "#444" }}>You can add a key later in Settings → AI</div>
          )}
        </div>
      )}
